...
from dataset0 import OilDataset
...
parser.add_argument('--dataset_dir', type=str, default='../data/Oil/', help='dir of the dataset')

parser.add_argument('--data_type', type=str, default='Oil', help='KP|AP|F10.7|Oil')
parser.add_argument('--time_step', type=int, default= 7, help=' it indicates day')
...
'''
data_fname = ['oil_198_train.xls', 'oil_198_test.xls']
train_data_path = os.path.join(opt.dataset_dir, data_fname[0])
test_data_path = os.path.join(opt.dataset_dir, data_fname[1])

train_dataset = OilDataset(train_data_path, opt.time_step, opt.pred_len, opt.data_type)
test_dataset = OilDataset(test_data_path, opt.time_step, opt.pred_len, opt.data_type)
